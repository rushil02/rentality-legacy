        ...
        <ul className="list-inline">
          ...
          <li className="list-inline-item">
            <div className="custom-control custom-checkbox">
              ...
              {this.props.errors.agreeToPay && <div style={{color: "red"}}>Please agree to the payment terms before progressing</div>}
            </div>
          </li>
          <li className="list-inline-item">
            <div className="custom-control custom-checkbox">
              ...
              {this.props.errors.agreeToTermsAndConditions && <div style={{color: "red"}}>Please agree to the T&Cs before progressing</div>}
            </div>
          </li>
        </ul>
      </div>
