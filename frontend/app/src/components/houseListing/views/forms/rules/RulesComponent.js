                ...
                <div className="col-md-10">
                    ...
                    <div>
                        <h2 className={styles.title}>
                            Is there anything else that your guest need to be be aware of?{" "}
                        </h2>
                        <div className="row">
                        ...
                        <p className={styles.noteInfo}>
                            Please Note: these house rules will be accepted by the guest before they book your
                            accommodation.
                        </p>
                    </div>
                </div>
            ...
            <div className="row">
                ...
                <div className="col-md-12 col-lg-12 col-xl-7">
                    <div className="input no-background">
                        <input
                            type="text"
                            className={"form-control " + styles.comments}
