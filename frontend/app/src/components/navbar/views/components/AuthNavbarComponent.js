...
export default class AuthNavbarComponent extends Component {
    componentDidMount() {
        ...
        $(window).resize(function () {
            $("#root > .menu.white .gray").css(
                "left",
                $("#root > .menu.white .right .list-inline li.person").offset().left + "px"
            )
        })
        $(window).resize()
                            ...
                            <div className="col-md-12 col-lg-12 col-xl-4 right align-self-center">
                                <ul className="list-inline">
                                    ...
                                    <li className="list-inline-item person">
                                        <a
                                            href={reverse(routes.react.dashboard.base)}
                                    ...
                                    <li className="list-inline-item setting">
                                        <div className="dropdown">
                                            ...
                                            <div className="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href={reverse(routes.auth.logout)} className="dropdown-item">
                                                    Logout
                                                </a>
                                            </div>
                                        </div>
