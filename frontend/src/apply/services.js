...
export function getHomeOwnerDetails(houseUUID) {
    return new Promise(function (resolve, reject) {
        axios
            .get(reverse(routes.apply.homeOwnerDetails, {houseUUID: houseUUID}))
            .then((response) => {
                resolve(response.data);
            })
            .catch((error) => {
...
export function getUnavailableDates(houseUUID) {
    return new Promise(function (resolve, reject) {
        axios
            .get(reverse(routes.apply.unavailableDates, {houseUUID: houseUUID}))
            .then((response) => {
                resolve(response.data);
            })
            .catch((error) => {
...
export function applyBooking(houseUUID, data) {
    return new Promise(function (resolve, reject) {
        axios
            .post(reverse(routes.apply.applyBooking, {houseUUID: houseUUID}), data.serialize())
            .then((result) => {
                resolve(result);
            })
            .catch((error) => {
