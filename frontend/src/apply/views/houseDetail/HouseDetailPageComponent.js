...
export default class HouseDetailPageComponent extends Component {
    ...
    handleScroll = () => {
        let threshold = this.elementRefs.bookingSection.offsetTop + this.elementRefs.bookingSection.offsetParent.offsetTop - (0.3 * window.innerHeight);
        if ((window.pageYOffset || document.documentElement.scrollTop) > threshold) {
            ...
            if (!this.state.bookButtonActive) {
                this.setState(prevState => ({...prevState, bookButtonActive: true}))
            }
        } else {
            if (this.state.bookButtonActive) {
                this.setState(prevState => ({...prevState, bookButtonActive: false}))
            }
        }
    };
    ...
    render() {
        ...
        let homeOwnerName = startCase(lowerCase(this.props.homeOwnerInfo.getData('firstName'))) + " " + startCase(lowerCase(this.props.homeOwnerInfo.getData('lastName')));
                                ...
                                <div className="left">
                                            ...
                                            <div className="col-md-3">
                                                <div className={styles.icon}>
                                                    <div className={styles.iconImage}>
                                                        <img src="/static/image/page-detail/left-box/1.svg" alt=""
                                                             title=""/>
                                                    </div>
                                                    <p className={styles.boxText}>{this.props.house.getData('numBedrooms')} bedrooms</p>
                                                </div>
                                            </div>
                                            <div className="col-md-3">
                                                <div className={styles.icon}>
                                                    <div className={styles.iconImage}>
                                                        <img src="/static/image/page-detail/left-box/2.svg" alt=""
                                                             title=""/>
                                                    </div>
                                                    <p className={styles.boxText}>{this.props.house.getData('numBathrooms')} bathroom</p>
                                                </div>
                                            </div>
                                            <div className="col-md-3">
                                                <div className={styles.icon}>
                                                    <div className={styles.iconImage}>
                                                        <img src="/static/image/page-detail/left-box/3.svg" alt=""
                                                             title=""/>
                                                    </div>
                                                    <p className={styles.boxText}>{this.props.house.getData('numParkSpaces')} Garage</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className={styles.about}>
                                        ...
                                        <p className={styles.pg}>
                                            {this.props.house.getData('accessRestrictions')}
                                        </p>
                                        {
                                    ...
                                    <div className={styles.rule}>
                                        ...
                                        <p style={{
                                            marginTop: '20px',
                                            marginBottom: '30px'
                                        }}>{this.props.house.getData('otherRules')}</p>

                                        <div className={styles.pg}>Minimum Length of Stay
                                            - <b>{this.props.house.getData('minStay')}</b></div>

                                        <div className={styles.pg}>Maximum Length of Stay
                                            - <b>{this.props.house.getData('maxStay') !== 0 ? this.props.house.getData('maxStay') : "No Limit"}</b>
                                        </div>

                                        <div className={styles.pg}>Maximum Number of People Allowed
                                            - <b>{this.props.house.getData('maxPeopleAllowed')}</b></div>
                                    </div>

                                    <div className={styles.infoSection}>
                                        <h2 className={styles.hl2}>Cancellation Policy</h2>
                                        <h3 className={styles.hl3}>{this.props.cancellationPolicy.getData('verbose')}</h3>
                                    ...
                                    <div className={styles.infoSection}>
                                        ...
                                        <p className={styles.pg}>{this.props.house.getData('neighbourhoodDescription')}</p>
                                    </div>
                                        ...
                                        <div className={"row"} style={{marginBottom: "30px"}}>
                                            <div className={"col-3"}>
                                                <div style={{textAlign: "center"}}>
                                                    <img src={this.props.homeOwnerInfo.getData('profilePicture')}
                                                         className={"rounded-circle " + styles.userImage} alt=""
                                                         title=""/>
                                                </div>
                                            </div>
                                            <div className={"col-9"}>
                                                ...
                                                <div className={"list " + styles.tagList}>
                                                    ...
                                                    <ul className={"list-inline " + styles.listInline}>
                                                        {this.props.homeOwnerInfo.getData('personalityTags').map((item, index) =>
