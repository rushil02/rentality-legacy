...
import AvailabilitySelectorHandler from "containers/house/AvailabiltySelector";
                        ...
                        <div className="col-md-10">
                            ...
                            <div className="row">
                                <div className="col-md-12 col-lg-6">
                                    <div className="input number-disp no-background" onClick={() => {this.rentInput.focus()}}>
                                        <label>Rent</label>
                                        <input type="number" name="main-form-rent" min="0"
                                               id="id_main-form-rent" placeholder="$AUD"
                                ...
                                <div className="col-md-12 col-lg-6"/>
                                <div className="col-md-12 col-lg-6">
                                    <div className="input number-disp no-background" onClick={() => {this.minStayInput.focus()}}>
                                        <label>Minimum length of stay</label>
                                        <input type="number" name="main-form-min_stay"
                                               min="28" id="id_main-form-min_stay"
                                               ref={(input) => { this.minStayInput = input; }}
                                ...
                                <div className="col-md-12 col-lg-6">
                                    <div className="input number-disp no-background" onClick={() => {this.maxStayInput.focus()}}>
                                        Maximum length of stay
                                        <input type="number" name="main-form-max_stay" min="0"
                                               id="id_main-form-max_stay"
                                               ref={(input) => { this.maxStayInput = input; }}
                                               value={this.props.maxStay}
                                               onChange={(e) => this.props.onFieldChange("maxStay", e.target.value)}
                                        />
                                    </div>
                                    <small className="form-text text-muted">
                                        in days. 0 signifies no limit.
                                    </small>
                                ...
                                <div className="col-md-12 col-lg-6">
                                    <div className="input number-disp no-background" onClick={() => {this.maxPeopleAllowedInput.focus()}}>
                                        <label>Maximum people allowed</label>
                                        <input type="number" name="main-form-max_people_allowed"
                                               min="1" id="id_main-form-max_people_allowed"
                                               ref={(input) => { this.maxPeopleAllowedInput = input; }}
