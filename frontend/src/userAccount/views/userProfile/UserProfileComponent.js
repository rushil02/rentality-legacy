                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className={styles.header}>
                                        <ul className={"list-inline " + styles.listInline} style={{marginBottom: "0"}}>
                                            <li className="list-inline-item">
                                                <NavLink to={reverse(routes.react.user.userProfile)}
                                            ...
                                            <li className="list-inline-item">
                                                <a href={reverse(routes.react.user.paymentInfo)}
                                                   className={styles.btn + " btn btn-link"}>
                                                    Payment Information
                                                </a>
                                            </li>
                                        ...
                                        <div className="col-md-6 col-lg-6 col-xl-6" id={"main-form"}>
                                            ...
                                            <div className="row">
                                                ...
                                                <CountryAutoSuggestContainer
                                                    ...
                                                    onFieldChange={(value) => props.onFieldChange('billingCountryID', value)}
                                                ...
                                                <div className="col-md-12">
                                                    <div className="input no-background">
                                                        <input type="text" value={props.contactNum}
                                                ...
                                                <div className="col-md-12">
                                                    <p className={styles.infoText}><span>Please Note:</span> We wil not
                                            ...
                                            <h1 className={styles.title} style={{marginTop: "30px"}}>Billing
                                                Address</h1>
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="input no-background">
                                                        <input type="text" value={props.billingStreetAddress}
                                                               className="form-control"
