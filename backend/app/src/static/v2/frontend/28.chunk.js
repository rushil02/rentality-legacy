...
/***/ "./src/houseListing/views/forms/welcomeTags/WelcomeTagsContainer.js":
/*!**************************************************************************!*\
  !*** ./src/houseListing/views/forms/welcomeTags/WelcomeTagsContainer.js ***!
  \**************************************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WelcomeTagsContainer; });
...
var WelcomeTagsContainer =
/*#__PURE__*/
function (_Component) {
  _inherits(WelcomeTagsContainer, _Component);

  function WelcomeTagsContainer(props) {
    var _this;

    _classCallCheck(this, WelcomeTagsContainer);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(WelcomeTagsContainer).call(this, props));
    _this.formID = 11;
    ...
    _this.onTagAdd = function (input) {
      ...
      if (text !== "") {
        _this.setState(function (prevState) {
          return {
            data: prevState.data.update(new houseListing_models__WEBPACK_IMPORTED_MODULE_3__["WelcomeTag"]({
              id: null,
              verbose: text,
              checked: true
            }, 'hasChanged'), text)
    ...
    _this.onSave = function (e) {
      ...
      return new Promise(function (resolve, reject) {
        Object(houseListing_services__WEBPACK_IMPORTED_MODULE_2__["postWelcomeTags"])(that.props.houseUUID, that.state.data).then(function (tagList) {
          that.setState({
            data: tagList
          });
    ...
    if (props.cache.data === undefined) {
      _this.state = {
        data: new core_utils_ModelHelper__WEBPACK_IMPORTED_MODULE_4__["APIModelListAdapter"]([], houseListing_models__WEBPACK_IMPORTED_MODULE_3__["WelcomeTag"], 'id', 'empty')
      };
    } else {
      _this.state = {
  ...
  _createClass(WelcomeTagsContainer, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.state.data.status === 'empty') {
        Object(houseListing_services__WEBPACK_IMPORTED_MODULE_2__["getWelcomeTags"])(this.props.houseUUID).then(function (result) {
    ...
    value: function componentWillUnmount() {
      ...
      this.props.cache.updateStoreObject('welcomeTagsData', function () {
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, "Select the groups that are welcome in your home"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "row"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-md-12"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WelcomeTagCheckbox, {
          data: data[1],
          key: data[0].toString(),
...
function WelcomeTagCheckbox(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
    ...
    id: "wt-checkbox-".concat(props.objReference),
    onChange: function onChange(e) {
      props.onChange(props.objReference, e.target.checked);
    }
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", {
    className: "custom-control-label",
    htmlFor: "wt-checkbox-".concat(props.objReference)
