# Generated by Django 2.2.10 on 2020-04-13 07:54
...
def populate_for_legacy_data(apps, schema_editor):
    ...
    PGLocationRestriction = apps.get_model('payment_gateway', 'LocationRestriction')
    ...
    PGLocationRestriction.objects.create(
