    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('furnished', models.CharField(blank=True, max_length=1, verbose_name='Furnished')),
                ...
                ('rent', models.PositiveSmallIntegerField(blank=True, help_text='Per Week in AUD', null=True)),
