    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('I', 'Inactive'), ('P', 'Published'), ('L', 'Leased'), ('D', 'Deleted')], default='I', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_type', models.CharField(choices=[('R', 'Preferences'), ('F', 'Facility')], max_length=1)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
            ],
        ),
